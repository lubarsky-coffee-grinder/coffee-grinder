...
Создавайте резюме для озвучки длительностью около сорока секунд (ориентир: от тридцати пяти до сорока секунд).
Встраивайте название статьи (не обязательно) и источник (обязательно) естественным образом в текст.
Источник должен быть озвучен явно: используйте формулировку вида «Как сообщает [источник], ...» или «По данным [источник], ...».
