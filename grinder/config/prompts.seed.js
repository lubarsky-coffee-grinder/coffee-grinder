...
Финальная фраза должна явно называть агентство его полным названием, без сокращений.
Формулировка финальной фразы должна быть вариативной: не повторяйте один и тот же шаблон в соседних резюме и не используйте только конструкцию «Об этом сообщает ...».
Используйте разные нейтральные конструкции, например: «По данным [полное название источника].», «Как пишет [полное название источника].», «Согласно публикации [полное название источника].», «Это следует из материала [полное название источника].».
В резюме должна быть только одна финальная фраза с источником.
